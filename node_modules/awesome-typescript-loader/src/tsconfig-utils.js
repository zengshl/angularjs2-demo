...
function tsconfigSuggestions(config) {
    ...
    var hasExclude = config.exclude && (config.exclude.indexOf('node_modules') !== -1
        || config.exclude.indexOf('./node_modules') !== -1);
    var hasGlobIgnore = config.filesGlob && (config.filesGlob.some(function (item) { return item.indexOf('!node_modules') !== -1; })
        || !config.filesGlob.some(function (item) { return item.indexOf('!./node_modules') !== -1; }));
