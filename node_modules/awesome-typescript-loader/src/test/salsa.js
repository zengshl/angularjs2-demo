...
describe('salsa test', function () {
    it('should compile js file', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var tsconfig = utils_1.fixturePath(['salsa', 'tsconfig.json']);
            var loaderQuery = { tsconfig: tsconfig };
            var exclude = [/exclude/];
            var stats = yield utils_1.cleanAndCompile(utils_1.createConfig(config, { loaderQuery: loaderQuery, exclude: exclude }));
