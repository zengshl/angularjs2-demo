...
var DataTable = (function () {
    function DataTable() {
        ...
        this.fpage = new core_1.EventEmitter();
    }
    ...
    DataTable.prototype.calculateNewActivePage = function (previousRowsOnPage, currentRowsOnPage) {
        var firstRowOnPage = (this.inputData.page - 1) * previousRowsOnPage + 1;
    ...
    DataTable.prototype.fillData = function () {
        ...
        var offset = (this.inputData.page - 1) * this.inputData.size; //开始的记录
