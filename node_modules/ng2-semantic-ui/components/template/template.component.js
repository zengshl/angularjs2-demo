// import {Component, HostBinding, Input, ViewContainerRef, EmbeddedViewRef, DynamicComponentLoader, ElementRef} from '@angular/core';
...
//         if (id) {
//             this._local = true;
//             // this._view = this._viewContainer.createEmbeddedView(templateStore.retrieveTemplate(id), this._context);
//
...
//                     .subscribe(
//                         (template:string) => {
//                             this._dynamicComponentLoader.loadNextToLocation(TemplateComponent.generateComponent(template, url, this._context), this._viewContainer);
//                             setTimeout(() => {
//                                 this.id = url;
//                             });
//                         },
